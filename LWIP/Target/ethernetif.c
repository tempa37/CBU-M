...
#ifdef DEBUG
extern UBaseType_t HighWaterMarkETH;
extern UBaseType_t HighWaterMarkETH_IN;
#endif
...
void ethernetif_input(void* argument)
{
  ...
  {
#ifdef DEBUG
  HighWaterMarkETH_IN = uxTaskGetStackHighWaterMark(NULL);
#endif
...
void ethernet_link_thread(void* argument)
{
  ...
  for(;;)
  {
    ...
    else if(!netif_is_link_up(netif) && (PHYLinkState > LAN8710_STATUS_LINK_DOWN))
    {
      switch (PHYLinkState)
      {
        case LAN8710_STATUS_100MBITS_FULLDUPLEX: {
